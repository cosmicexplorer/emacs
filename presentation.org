...
* Outline
1. What is a regular expression? When and how does implementation match formal theory?
2. What are regexps used for? How do Emacs users use them?
3. How do regex-emacs.c and search.c invoke the regex engine from lisp code?
4. What does Emacs require from a regex engine? How does that differ from other engines?
  - What is the input to the regex engine? When and how does the multibyte encoding come into play?
5. Future Directions: Introspection, Composability, and Optimization
