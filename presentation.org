...
*** Who are you?
Danny McClanahan:
- I failed an Independent Study in Compiler Design in undergrad to make a C compiler because (as my prof /specifically/ warned me against) I got stuck on the parser.
- I then spent the next several years realizing that was actually what I should have been doing the whole time.
*** Why are you here?
